...
public class Demo {
	...
	static Book book1=new Book("0", "图书管理系统说明书", "余祉奕");
	static Book book2=new Book("1", "西南科技大学", "绵阳");
	static Book book3=new Book("51201862902", "软件工程1806", "余祉奕");
	//创建三个图书对象
